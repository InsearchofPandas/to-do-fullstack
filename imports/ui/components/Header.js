  ...
  return (
    <>
      ...
      <div className='header-bar'>
        <svg width='20' height='28' viewBox='0 0 37 46' fill='none' xmlns='http://www.w3.org/2000/svg'>
          <path
            fill-rule='evenodd'
            clip-rule='evenodd'
      ...
      <div className='header'>
        <p className='instructions'>
          An application dedicated to helping you track and complete your goals and resolutions. Utilizing the framework
          of Apollo to set up a GraphQL front end client and back end API your data is stored on mongoDB. It then is
          easily accessed through any web browser simply by logging in.
        </p>
      </div>
    </>
  );
