  ...
  return (
    <>
      ...
      <div className='header-bar'>
        <div className='user'>
          <div className={'user-icon ' + (user ? ' ' : ' header-bar-visibility')}>
        ...
        <button
          ...
          className={'logout-btn ' + (user ? ' ' : ' header-bar-visibility')}>
          Logout
        </button>
      </div>
      ...
      <div className='header-body'>
        <p className='instructions'>
          An application dedicated to helping you track and complete your New Year's resolutions. Utilizing the framework React, Apollo Client, Apollo
          Server and Meteor to set up a GraphQL front end client and back end API. The data is stored using mongoDB. It then is easily accessed
          through any web browser simply by logging in.
        </p>
      </div>
    </>
  );
